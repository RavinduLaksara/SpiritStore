...
// Get supplier id
$sql = "SELECT supplier_id FROM store WHERE store_id = '$store_id'";
    ...
    if ($uploadOk) {
        ...
        if (move_uploaded_file($_FILES['photo']['tmp_name'], $target_file)) {
            ...
            do {
                ...
                $sql = "INSERT INTO storeproduct (StoreID, ProductID, Quantity, Price) VALUES ('$store_id', '$product_id', '$price', '$quantity')";
                $result = $connection->query($sql);
...
<body>
    <div class="content">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="number" placeholder="Quantity" name="quantity" min="1"><br>
